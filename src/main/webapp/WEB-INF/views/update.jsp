...
<!-- contents -->
<div class="contents">
	<form class="form" method="post" action="update.do">
		<input type="hidden" name="seq" value="${update.seq}">
		<div class="input input__text">
			<input type="text" name="id" placeholder="ID" class="input" value="${update.id}" required />
		</div>
		<div class="input input__text">
			<input type="text" name="subject" placeholder="SUBJECT" class="input" value="${update.subject}" required />
		</div>
		<div class="input input__textarea">
		    <textarea name="description" placeholder="DESCRIPTION" class="input" required>${update.description}</textarea>
		</div>
		<div class="input input__textarea">
		    <textarea name="code" placeholder="CODE" class="input" required>${update.code}</textarea>
		</div>
